...
<body>
    <section class="jumbotron bg-[#cee3f3] bg-[url('/public/assets/news.jpg')] bg-cover min-h-[50vh]">
        <!--Jumbotron-->
                ...
                <div class="row flex justify-around items-center">
                    ...
                    <div>
                        <ul class=" flex gap-7">
                            ...
                            <li><a href="/berita"
                                    class=" font-semibold text-white text-lg  underline underline-offset-8">Berita</a>
                            </li>
                        </ul>
                    </div>
                    <div>
        ...
        <div class="container mx-auto w-9/12 pt-12">
            <H1 class=" font-bold text-white text-6xl py-5">Berita</H1>
        </div>
    </section>
    <section class="z-0">
        <div class=" container mx-auto w-9/12">
            <h1 class=" text-[#ff9e5d] text-[52px] font-bold mt-5">Berita Sumsel</h1>
            <div class=" flex mt-10 gap-8 mb-20">
