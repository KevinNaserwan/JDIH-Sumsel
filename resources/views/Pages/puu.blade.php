    ...
    <section>
        <div class=" container mx-auto w-9/12 py-10">
            <div class=" flex items-center pb-7">
                <a href="" class=" hover:text-orange-400">Beranda / Peraturan Perundang Undangan</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 font-bold text-xl text-gray-900 whitespace-nowrap">
                                <a href="/detailpuu/{{$item->jenis_dokumen}}" class=" hover:text-amber-500">{{$item->jenis_dokumen}}</a>
                            </th>
