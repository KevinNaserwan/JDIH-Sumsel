                ...
                <table class="w-full text-sm text-left rtl:text-right text-white border-black border">
                    ...
                    <tbody>
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 font-normal text-base text-gray-900 whitespace-nowrap">
                        ...
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal  text-gray-900 whitespace-nowrap">
                                Tahun : {{ $dokumen->tahun }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                        ...
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Singkatan Jenis : {{ $dokumen->singkatan }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Tempat Terbit : {{ $dokumen->tempat }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Tanggal Penetapan : {{ $dokumen->tanggal_tetap }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Tanggal Pengundangan : {{ $dokumen->tanggal_pengundangan }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Subyek : {{ $dokumen->subyek }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                        ...
                        <tr class="bg-white border-b border-black">
                            <th scope="row" class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Pemrakarsa : {{ $dokumen->pemrakarsa }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                                class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                        ...
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                                class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Urusan Pemerintahan : {{ $dokumen->urusan }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                                class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Bidang Hukum : {{ $dokumen->bidang }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                                class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Bahasa : {{ $dokumen->bahasa }}
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                                class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Unduhan :<a  download="{{ $dokumen->dokumen }}" href="{{ asset('storage/dokumen/' . $dokumen->dokumen) }}" class=" bg-amber-400 text-white rounded-lg py-1 ml-3  px-2 font-semibold hover:bg-amber-700">Download</a>
                            </th>
                        </tr>
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                        ...
                        <tr class="bg-white border-b border-black">
                            <th scope="row"
                                class="px-6 py-4 text-base font-normal text-gray-900 whitespace-nowrap">
                                Detail Dokumen:
                                <embed class=" mt-4" src="{{ asset('storage/dokumen/' . $dokumen->dokumen) }}"
                                    type="application/pdf" width="100%" height="600px" />
                                <!-- Or using iframe -->
                                <!-- <iframe src="{{ asset('storage/dokumen/' . $dokumen->dokumen) }}" width="100%" height="600px"></iframe> -->
                            </th>
                        </tr>
                    </tbody>
                </table>
