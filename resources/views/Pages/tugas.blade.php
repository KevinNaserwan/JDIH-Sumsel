...
<body>
    <section class="jumbotron bg-[#cee3f3] bg-[url('/public/assets/tugas.jpg')] bg-cover min-h-[70vh]">
        <!--Jumbotron-->
        ...
        <div class="container mx-auto w-9/12 pt-28">
            <H1 class=" font-bold text-white text-6xl py-5">Tugas dan Fungsi</H1>
        </div>
    </section>
    <section>
        <div class=" container mx-auto w-9/12">
            <div>
                <div class=" flex items-center mt-20">
                    <a href="" class=" hover:text-orange-400">Beranda / Tugas dan Fungsi</a>
                </div>
                <div class="mt-8 mb-10">
                    <h1 class=" text-[#333333] font-bold text-[28px]">Tugas JDIH</h1>
                    <ol start="" class=" mt-2">
                        <li class=" pt-1">1. Menyimpan hasil kegiatan penyusunan produk hukum daerah.</li>
                        <li class=" pt-1">2. Melakukan pengumpulan, pengelolaan, penyimpanan dan penyebarluasan produk hukum daerah dan instrumen hukum lainnya. </li>
                        <li class=" pt-1">3. Menyiapkan bahan hukum untuk mengambil keputusan. </li>
                        <li class=" pt-1">4. Penataan sistem informasi hukum melalui pemanfaatan teknologi informasi dan komunikasi. </li>
                        <li class=" pt-1">5. Menyiapkan bahan perencanaan hukum dan perancangan produk hukum daerah, dan penyuluhan hukum. </li>
                        <li class=" pt-1">6. Memberikan fasilitas teknis dalam rangka penyelenggaraan dokumentasi dan informasi hukum pada anggota jaringan. </li>
                        <li class=" pt-1">7. Menyelenggarakan dan membina komunikasi dengan anggota jaringan, dan </li>
                        <li class=" pt-1">8. Melayani masyarakat dalam memperoleh informasi hukum secara mudah, cepat,tepat dan akurat. </li>
                    </ol>
                </div>
                <div class="mt-8 mb-20">
                    <h1 class=" text-[#333333] font-bold text-[28px]">Fungsi JDIH</h1>
                    <ol start="" class=" mt-2">
                        <li class=" pt-1">1. Pusat informasi hukum daerah.</li>
                        <li class=" pt-1">2. Pusat pengumpulan, penyimpanan, pengolahan, penyebarluasan dan pengelolaan dokumentasi hukum secara manual dan digital.</li>
                        <li class=" pt-1">3. Pembinaan dan pendidikan pengelola JDIH. </li>
                        <li class=" pt-1">4. Koordinasi dan konsultasi anggota jaringan. </li>
                    </ol>
                </div>
            </div>
        </div>
