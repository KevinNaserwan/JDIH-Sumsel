...
<body>
    <section class="jumbotron bg-[#cee3f3] bg-[url('/public/assets/galeri.jpeg')] bg-cover min-h-[70vh]">
        <!--Jumbotron-->
                ...
                <div class="row flex justify-around items-center">
                    ...
                    <div>
                        <ul class=" flex gap-7">
                            ...
                            <li><a href="/galeri"
                                    class=" font-semibold text-white text-lg  underline underline-offset-8">Galeri</a>
                            </li>
                            <li class="group"><a href=""
        ...
        <div class="container mx-auto w-9/12 pt-28">
            <H1 class=" font-bold text-white text-6xl py-5">Galeri</H1>
        </div>
    </section>
    <section>
        <div class=" container mx-auto w-9/12">
            <div>
                ...
                <div class=" flex gap-10 mt-16 mb-20">
